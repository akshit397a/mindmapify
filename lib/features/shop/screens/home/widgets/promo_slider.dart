...
import 'package:mindmapify/features/shop/controllers/home_controller.dart';
        ...
        CarouselSlider(
          options: CarouselOptions(
              ...
              autoPlayInterval: const Duration(
                  seconds: 3), // Adjust the duration between slides
              autoPlayAnimationDuration: const Duration(
                  milliseconds: 1000), // Control the animation duration
              autoPlayCurve:
                  Curves.fastOutSlowIn, // Apply a smooth curve for animation
