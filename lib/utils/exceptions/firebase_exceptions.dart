...
class AppFirebaseException implements Exception {
  ...
  // Constructor takes the error code.
  ...
  String get message {
    switch (code) {
      ...
      case 'user-token-mismatch':
        return 'The user\'s token has a mismatch with the authenticated user\'s user ID.';
      case 'invalid-message-payload':
        return 'The email template verification message payload in invalid.';
      case 'invalid-sender':
